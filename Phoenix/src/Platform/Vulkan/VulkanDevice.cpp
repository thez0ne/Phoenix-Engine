...
namespace Phoenix
{
    ...
    m_Instance(instance), m_Window(window)
  {
    ...
    PHOENIX_ASSERT(deviceCount > 0, "Failed to find Vulkan compatible device");
    ...
    PHOENIX_ASSERT(m_PhysicalDevice != VK_NULL_HANDLE, "Failed to find suitable GPU");
